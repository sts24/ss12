    ...
    <div class="col-s-12">
        ...
        <?php
            ...
            while ( $query->have_posts() ) {
                ...
                <li>
                    <a href="<?php the_permalink(); ?>" class="featured-grid-item" aria-labelledby="label-<?php echo $post->post_name; ?>">
                        <?php the_post_thumbnail('thumbnail'); ?>
                        <header role="button" id="label-<?php echo $post->post_name; ?>"><?php the_title(); ?></header>
                    </a>
                </li>
